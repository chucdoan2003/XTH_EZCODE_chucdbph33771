...
<style>
.bgImg {
    background-image: url('<?php echo BASE_URL ?>/public/assets/image/login/bglogin.jpg');
}
</style>
...
<body>
    <div class="bgImg">
        <div class="wrap_login">
            <div class="img_decor">
                <img src="<?php echo BASE_URL ?>/public/assets/image/login/laptoplearn.jpg" alt="">
            </div>
                ...
                <div class="wrap__form-login">
                    ...
                    <form action="<?=BASE_URL?>user/login" method="POST">
                        ...
                        <div class="check__forgot">
                            ...
                            <div class="forgotPass"><a href="<?=BASE_URL?>/user/forgot">Forgot passwords
                                    ?</a></div>
                        </div>

                        <button type="submit" class="btn-login" name="login">Login</button>
                        <div>
                            <a href="<?=BASE_URL?>/user/register"><button class="btn-register" type="button">
